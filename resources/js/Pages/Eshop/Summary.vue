<template>
    <Head :title="lang[locale].eshopSummaryTitle"/>
    <main-layout>
        <div class="max-w-xl mx-auto pt-8">
            ...
            <div v-if="basket.length" class="mb-4">
                <table class="border-collapse border border-slate-400 shadow-md w-full text-sm">
                    <thead class="bg-gray-200">
                    <tr>
                        <th class="border border-slate-400 p-2" colspan="2">{{ lang[locale].eshopBasketPanel }}</th>
                    </tr>
                    </thead>
                    <tbody>
            ...
            <div class="mb-4">
                <table class="border-collapse border border-slate-400 shadow-md w-full text-sm">
                    <thead class="bg-gray-200">
                    <tr>
                        <th class="border border-slate-400 p-2" colspan="2">{{ lang[locale].eshopInfoPanel }}</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td v-if="!customer.show_billing_panel" class="border border-slate-400 w-2/3 p-2">
                            {{ lang[locale].eshopBillingPanelNote }}
                        </td>
            ...
            <p v-if="emptyBasket" class="text-sm text-red-500 font-bold">
