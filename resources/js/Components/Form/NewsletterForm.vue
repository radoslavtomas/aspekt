<template>
    <div class="mt-8 bg-gray-200 rounded shadow-md p-4">
        <section class="flex flex-col justify-start">
            ...
            <form action="#" @submit="handleSubscription" class="w-full flex justify-center items-center flex-col sm:flex-row mx-auto md:max-w-screen-sm mt-8">
                <label class="block w-full flex-1 mb-4 sm:mb-0">
                    <input type="email"
                           required
                           name="subscribe_email"
                           placeholder="Email"
                           v-model="form.subscribe_email"
...
import {HandThumbUpIcon, CheckIcon, ArrowPathIcon} from '@heroicons/vue/24/outline';
